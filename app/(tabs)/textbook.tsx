...
function createStyles(colors: AppColors) {
  return StyleSheet.create({
    ...
    headerSub: { fontSize: 13, color: colors.accentBorder },
    ...
    addButtonText: { color: colors.textInverse, fontSize: 16, fontWeight: "bold" },
    emptyCard: {
    ...
    emptyTitle: { fontSize: 16, fontWeight: "bold", color: colors.textSecondary, marginBottom: 8 },
    ...
    bookSubjectText: { color: colors.accent, fontSize: 12, fontWeight: "600" },
    bookDate: { color: colors.textMuted, fontSize: 12 },
    bookName: { fontSize: 16, fontWeight: "bold", color: colors.textPrimary, marginBottom: 4 },
    bookDesc: { fontSize: 13, color: colors.textSecondary, marginBottom: 8 },
    bookFooter: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
    bookPages: { fontSize: 13, color: colors.textSecondary },
    deleteButton: {
    ...
    deleteButtonText: { color: colors.dangerText, fontSize: 13, fontWeight: "600" },
    modalContainer: { flex: 1, backgroundColor: colors.inputBg },
    modalHeader: {
      backgroundColor: colors.accentDark,
      padding: 20,
      flexDirection: "row",
    ...
    modalTitle: { color: colors.textInverse, fontSize: 20, fontWeight: "bold" },
    ...
    subjectChipText: { color: colors.textSecondary, fontSize: 13, fontWeight: "600" },
    subjectChipTextActive: { color: colors.textInverse },
    input: {
      backgroundColor: colors.cardBg,
      borderRadius: 10,
      padding: 12,
    ...
    registerButtonText: { color: colors.textInverse, fontSize: 16, fontWeight: "bold" },
    registerHint: { fontSize: 12, color: colors.textMuted, textAlign: "center", marginTop: 12, lineHeight: 18 },
    progressContainer: { marginTop: 12, gap: 6 },
    progressBarTrack: { height: 8, backgroundColor: colors.cardBorder, borderRadius: 4, overflow: "hidden" },
    progressBarFill: { height: 8, backgroundColor: colors.accent, borderRadius: 4 },
    progressPercent: { fontSize: 12, color: colors.textSecondary, textAlign: "center", fontWeight: "600" },
    progressBox: { paddingVertical: 48, alignItems: "center", gap: 16 },
    progressStatusText: { fontSize: 15, color: colors.textPrimary, fontWeight: "600", textAlign: "center" },
    successBox: { paddingVertical: 64, alignItems: "center", gap: 12 },
    successIcon: { fontSize: 56 },
    successTitle: { fontSize: 22, fontWeight: "bold", color: colors.successText },
    ...
    ctaBannerTitle: { fontSize: 16, fontWeight: "bold", color: colors.textAccent, textAlign: "center" },
    ctaBannerDesc: { fontSize: 13, color: colors.accent, textAlign: "center", lineHeight: 20 },
    ctaBannerButton: {
      backgroundColor: colors.accent,
      borderRadius: 10,
      paddingVertical: 12,
    ...
    ctaBannerButtonText: { color: colors.textInverse, fontSize: 14, fontWeight: "bold" },
    confirmTitle: { fontSize: 18, fontWeight: "bold", color: colors.textPrimary, marginBottom: 16, marginTop: 8 },
    confirmCard: {
      backgroundColor: colors.cardBg,
      borderRadius: 12,
      borderWidth: 1,
    ...
    confirmLabel: { fontSize: 13, color: colors.textSecondary, fontWeight: "600", flex: 1 },
    confirmValue: { fontSize: 13, color: colors.textPrimary, flex: 2, textAlign: "right" },
    warningBox: {
    ...
    warningText: { color: colors.warningDark, fontSize: 13 },
    backButton: {
      borderRadius: 12,
      paddingVertical: 14,
      alignItems: "center",
